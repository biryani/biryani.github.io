...
My work is organized into a few long-running threads — learning theory for exponential families, machine learning for quantum systems, quantum algorithms, and quantum walks. The [research]({{ '/projects/' | relative_url }}) page collects the papers belonging to each.
